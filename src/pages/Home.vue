<template>
  <div class="container">
    ...
    <p>
      ...
      logic to exclude certain options when they are not available for combination. Also, it involves implementing
      conditional statements and data validation to ensure the user's choices are valid
    </p>
  </div>
</template>
